 ...
 */
package com.flynetwork.game.srciptmanager;
...
public class MyClassLoader extends ClassLoader {
    ...
    public MyClassLoader(String sourceDir, String outDir) {
        ...
        this.OutDir = outDir;
        this.logger = Logger.getLogger(MyClassLoader.class);
        logger.debug("初始化 Class Loader 容器 Source：" + this.SourceDir + " out：" + this.OutDir + " 完成");
    }
    ...
    public boolean Compile(String fileName) {
        ...
        try {
            ...
            if (ret) {
                logger.debug("编译：" + this.SourceDir + fileName + " 的文件成功");
            } else {
                logger.debug("编译：" + this.SourceDir + fileName + " 的文件失败");
            }
            return ret;
        } catch (Exception ex) {
    ...
    public Class<?> loadClass(String name) throws ClassNotFoundException {
        ...
        if (tClass == null) {
            ...
            logger.debug("加载 " + this.OutDir + "" + name + " 成功");
        }
        return tClass;
    }
